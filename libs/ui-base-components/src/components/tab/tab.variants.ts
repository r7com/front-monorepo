import { VariantProps, createVariants } from '@r7-jarvics/utils'
...
export const variants = createVariants({
  slots: {
    ...
    icon: 'fill-light-low-400 group-active:fill-light-low-400  group-hover:fill-brand-primary-600 group-focus-visible:fill-brand-primary-500',
  },
  variants: {
    size: {
      small: {
    ...
    selected: {
      true: {
        button: '!text-brand-primary-500 border-b-brand-primary-500',
        icon: '!fill-brand-primary-500',
      },
      false: {
        button: '',
        icon: '',
