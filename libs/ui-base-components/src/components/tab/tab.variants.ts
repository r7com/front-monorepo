...
export const variants = createVariants({
  slots: {
    ...
    icon: 'fill-light-low-400 group-active:fill-light-low-400  group-hover:fill-brand-primary-600 group-focus-visible:fill-brand-primary-500 group-aria-selected:fill-brand-primary-500',
  },
  variants: {
    size: {
      small: {
