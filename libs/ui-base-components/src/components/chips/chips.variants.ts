...
export const variants = createVariants({
  ...
  variants: {
    ...
    color: {
      primary:
        'bg-brand-primary-500 text-neutral-high-500 hover:bg-brand-primary-600 hover:text-neutral-high-500 [&>svg]:hover:fill-neutral-high-500 focus:border-light-low-500 focus:!border-thin active:bg-brand-primary-600 active:shadow-inner-level5',
      secondary:
        'bg-highlight-500 text-neutral-high-500 hover:bg-highlight-600 hover:text-neutral-high-500 [&>svg]:hover:fill-neutral-high-500 focus:border-light-low-500 focus:!border-thin active:border-highlight-400 active:shadow-inner-level5',
      tertiary:
