...
export const variants = tv({
  ...
  variants: {
    color: {
      primary:
        'bg-brand-primary-500 hover:bg-brand-primary-600 active:bg-brand-primary-400 border-brand-primary-500 hover:border-brand-primary-600 active:border-brand-primary-600',
      secondary:
        'bg-highlight-500 hover:bg-highlight-600 active:bg-highlight-400 border-highlight-500 hover:border-highlight-600 active:border-highlight-600',
      tertiary:
